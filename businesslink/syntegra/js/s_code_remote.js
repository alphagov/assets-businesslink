...
*/
/************************** CONFIG SECTION **************************/
/* Businesslink version 1.4                                         */
/* You may add or alter any code config here.                       */
var s_cookieDomainPeriods="3"
/* Declare s_account to avoid error when reprot suite not set on the page*/
var s_account;
/* E-commerce Config */
...
var s_linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,rtf"
...
function s_doPlugins() {
	/* Add calls to plugins here */
      ...
      s_vp_getCGI('s_campaign','tc');
      s_vp_getCGI('tempVar','target');
      if(s_vp_getValue('tempVar'))
         s_vp_getCGI('s_eVar8','target');
      s_vp_getCGI('s_eVar16','domain');
      s_vp_getCGI('s_eVar17','furlname');
}
/************************** PLUGINS SECTION *************************/
